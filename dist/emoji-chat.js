...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';Object.defineProperty(exports,'__esModule',{value:true});var _createClass=(function(){function defineProperties(target,props){for(var i=0;i < props.length;i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if('value' in descriptor)descriptor.writable = true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _get=function get(_x,_x2,_x3){var _again=true;_function: while(_again) {var object=_x,property=_x2,receiver=_x3;_again = false;if(object === null)object = Function.prototype;var desc=Object.getOwnPropertyDescriptor(object,property);if(desc === undefined){var parent=Object.getPrototypeOf(object);if(parent === null){return undefined;}else {_x = parent;_x2 = property;_x3 = receiver;_again = true;desc = parent = undefined;continue _function;}}else if('value' in desc){return desc.value;}else {var getter=desc.get;if(getter === undefined){return undefined;}return getter.call(receiver);}}};function _interopRequireDefault(obj){return obj && obj.__esModule?obj:{'default':obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function');}}function _inherits(subClass,superClass){if(typeof superClass !== 'function' && superClass !== null){throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass);}subClass.prototype = Object.create(superClass && superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__ = superClass;}var _clappr=__webpack_require__(1);var _templateHtml=__webpack_require__(2);var _templateHtml2=_interopRequireDefault(_templateHtml);__webpack_require__(3);var EmojiChatPlugin=(function(_UIContainerPlugin){_inherits(EmojiChatPlugin,_UIContainerPlugin);_createClass(EmojiChatPlugin,[{key:'name',get:function get(){return 'EmojiChatPlugin';}},{key:'template',get:function get(){return (0,_clappr.template)(_templateHtml2['default']);}},{key:'defaults',get:function get(){return {emojis:['like','love','haha','wow','sad','angry'],bottom:false};}},{key:'attributes',get:function get(){return {'class':'emojis-container animated faster d-flex rounded ' + (this.options.emojiChat.bottom?'bottom-center':'')};}}]);function EmojiChatPlugin(options){_classCallCheck(this,EmojiChatPlugin);_get(Object.getPrototypeOf(EmojiChatPlugin.prototype),'constructor',this).call(this,options);this.options.emojiChat = this.options.emojiChat || {};this.options.emojiChat = Object.assign({},this.defaults,this.options.emojiChat);this.render();}_createClass(EmojiChatPlugin,[{key:'bindEmojiClickEvents',value:function bindEmojiClickEvents(){var _this=this;var icon=this.$el.find('.emoji-icon');icon.click(function(e){var zoomOutClass=_this.options.emojiChat.bottom?'zoomOutUp':'zoomOutRight';var el=$(e.target).addClass(zoomOutClass);setTimeout(function(){return el.removeClass(zoomOutClass);},1000);if(_this.options.emojiChat && _this.options.emojiChat.onClick){_this.options.emojiChat.onClick(el.data('emoji'));}});icon.mouseenter(function(e){$(e.target).addClass('rotateIn');setTimeout(function(){return $(e.target).removeClass('rotateIn');},1000);});}},{key:'updateEmojiCount',value:function updateEmojiCount(emoji,count){var badge=this.$el.find('.emoji-icon-' + emoji + '-count');if(badge){badge.html(count);}return this;}},{key:'updateViewCount',value:function updateViewCount(count){var badge=this.$el.find('.view_count');if(badge){badge.html(count);}}},{key:'show',value:function show(){this.$el.show();}},{key:'hide',value:function hide(){this.$el.hide();}},{key:'render',value:function render(){this.$el.hide();this.$el.html(this.template(this.options.emojiChat));this.container.$el.append(this.$el);this.$el.show();this.bindEmojiClickEvents();return this;}}]);return EmojiChatPlugin;})(_clappr.UIContainerPlugin);exports['default'] = EmojiChatPlugin;module.exports = exports['default'];
